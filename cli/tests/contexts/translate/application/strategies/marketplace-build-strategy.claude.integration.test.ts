...
// resolve(), never the bare literal: on Windows path.resolve prepends the current drive to a
// leading "/", so production's own resolve(outDir) would write under a different key.
