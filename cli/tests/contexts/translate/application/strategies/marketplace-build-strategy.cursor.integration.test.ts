...
// resolve(), not the bare literal: on Windows path.resolve treats a leading "/" as drive-
// relative, so production's own resolve(outDir) would write under a different key.
