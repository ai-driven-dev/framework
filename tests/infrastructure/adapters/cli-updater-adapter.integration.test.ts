...
import { CliUpdaterAdapter } from "../../../src/infrastructure/adapters/cli-updater-adapter.js";
...
function makeAdapter(): CliUpdaterAdapter {
  return new CliUpdaterAdapter(new HttpClient());
}
...
describe("cli-updater-adapter — package manager detection", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
