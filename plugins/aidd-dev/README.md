...
| [2.1] | [plan](skills/01-plan/README.md) | Generate an implementation plan from requirements, design a frontend page (behavior, dumb/smart split), or wireframe a screen at low fidelity. |
