...
| [2.6] | [test](skills/06-test/SKILL.md) | Write and iterate on developer-side tests until they pass, and validate user journeys end-to-end in the browser during implementation - not independent acceptance QA or reviewer evidence. |
