...
9. **Create `aidd_docs/tasks/<task-name>.in-progress.md`** using the plan template. Fill frontmatter (`objective`, `success_condition`, `iteration: 0`), Phases with Tasks and Acceptance criteria (the steps), and include the journey map.
