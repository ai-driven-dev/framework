...
The diff to review, a git ref range or path, from the arguments; defaults to `git diff main`.
...
1. **Resolve.** Take the diff from the arguments, otherwise `git diff main`.
