...
- Release notes are mandatory and follow `${CLAUDE_PLUGIN_ROOT}/skills/03-release-tag/assets/release-template.md`.
...
- `${CLAUDE_PLUGIN_ROOT}/skills/03-release-tag/assets/release-template.md`: Release notes template.
