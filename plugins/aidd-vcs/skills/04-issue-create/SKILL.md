...
- Issue body follows `${CLAUDE_PLUGIN_ROOT}/skills/04-issue-create/assets/issue-template.md`.
- Be thorough and concise. Short sentences. Focus on clarity, reproduction steps, and expected behavior.
- Read `${CLAUDE_PLUGIN_ROOT}/skills/04-issue-create/assets/CONTRIBUTING.md` for project-specific issue rules before drafting.
...
- `${CLAUDE_PLUGIN_ROOT}/skills/04-issue-create/assets/issue-template.md`: Issue / ticket body template.
- `${CLAUDE_PLUGIN_ROOT}/skills/04-issue-create/assets/CONTRIBUTING.md`: Contribution guidelines, including issue process.
