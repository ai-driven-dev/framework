...
- Follow the conventional commit format defined in `${CLAUDE_PLUGIN_ROOT}/skills/01-commit/assets/commit-template.md`.
...
- `${CLAUDE_PLUGIN_ROOT}/skills/01-commit/assets/commit-template.md`: Conventional commit format reference.
