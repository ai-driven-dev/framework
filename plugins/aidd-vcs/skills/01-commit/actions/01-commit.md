...
3. **Message.** Use an imposed message verbatim when given. In `auto`, generate one from the diff and recent log per `@../assets/commit-template.md`, no approval. In `interactive`, draft one and confirm.
