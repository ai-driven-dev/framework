...
4. Apply the transversal rules to every subsequent prose turn until the next off signal, using per-level rules from `@${CLAUDE_PLUGIN_ROOT}/skills/03-condense/references/intensity-levels.md`.
