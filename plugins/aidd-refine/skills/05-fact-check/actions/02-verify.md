...
5. **Judge.** Give each claim one verdict: verified (record every source), conflict (record both sides with their origin, pick no winner), or unverified (cascade exhausted, no source).
