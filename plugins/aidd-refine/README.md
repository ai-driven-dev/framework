...
Five skills that refine inputs and outputs through reflection: clarify vague requests, challenge prior work for correctness, analytically scan artifacts for blind spots, verify factual claims, and improve completed conversations.
...
| [5.5]      | [improve](skills/05-improve/SKILL.md) | Read complete conversation evidence, recommend targeted improvements, and propose minimal file edits. |
