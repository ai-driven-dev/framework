...
| `references` | [discovery-frame.md](skills/01-brainstorm/references/discovery-frame.md) | - |
...
| `-` | [SKILL.md](skills/01-brainstorm/SKILL.md) | `Clarify vague product or technical intent into a build-ready discovery brief. Use when the user has a half-formed idea, ambiguous request, or asks to brainstorm, discover, refine, or clarify. Not for artifact gap scans, planning, or code.` |
