...
1. **Enumerate connected MCP servers.** Read the AI tool's MCP config (`.mcp.json` for Claude Code, equivalent paths per tool; see `@${CLAUDE_PLUGIN_ROOT}/skills/06-discovery/references/ai-mapping.md`).
