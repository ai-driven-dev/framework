...
Write one canonical slash command from intent and render it once per host AI tool that supports commands. A sibling of `07-skill-generate` for the command artifact.
