...
3. **Validate `marketplace_name`** against the reserved-name list in `@${CLAUDE_PLUGIN_ROOT}/skills/03-context-generate/references/marketplace.md`. Block on match (exact or impersonation pattern).
