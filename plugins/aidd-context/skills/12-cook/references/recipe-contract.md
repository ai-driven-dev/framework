...
- Every step carries one concrete example: a command with its real output (show what it prints, not just the command), a config or snippet, a screenshot, or a short video/GIF link.
