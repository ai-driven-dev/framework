...
| [1.7] | learn | Capture and store learnings from recently implemented features into memory bank, decisions, or coding rules. |
| [1.8] | discovery | Help users discover installed skills and find the right one for their use case. |
