...
| [1.7]      | [cook](skills/12-cook/README.md)                       | Maintain the framework's `recipes/` how-to sheets - list every recipe, or create and update one from the canonical recipe template.                              |
