...
See `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/references/routing.md` for the full decision tree, signal precedence, and edge cases.
...
| 03  | `generate-workflow`               | Emit `.github/workflows/aidd-async.yml` from `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/assets/setup/workflow-template.yml`             |
| 04  | `generate-local-script`           | Emit poll/daemon scripts (local mode only) from `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/assets/setup/local-*-template.sh`            |
| 05  | `write-config`                    | Persist `.claude/aidd-orchestrator.json` from `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/assets/setup/config-template.json`             |
...
Files: `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/actions/setup/01-detect-context.md` ... `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/actions/setup/11-smoke-test.md`.
...
Files: `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/actions/run/01-poll-ready.md` ... `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/actions/run/06-write-audit.md`.
...
| 02  | `detect-stop`        | Decide stop vs continue using `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/references/review/stop-conditions.md`                       |
...
Files: `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/actions/review/01-collect-comments.md` ... `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/actions/review/04-finalize.md`.

Default flow: `01 → 02 → (03 → 01 loop if continue) → 04`. Stop conditions in `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/references/review/stop-conditions.md`.
...
- `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/references/routing.md` - full decision tree, signal precedence, conflict resolution.
- `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/references/setup/auth-modes.md` - local vs remote auth contracts.
- `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/references/setup/claude-action-auth.md` - `claude-code-action` token setup.
- `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/references/setup/local-mode-scheduling.md` - poll routine options.
- `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/references/review/stop-conditions.md` - when the review loop hands off to a human.

## Assets

Setup-only templates copied into the target repo by the setup sub-flow:

- `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/assets/setup/workflow-template.yml` - `.github/workflows/aidd-async.yml` skeleton.
- `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/assets/setup/local-poll-template.sh` - local-mode poll script.
- `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/assets/setup/local-daemon-template.sh` - local-mode daemon script.
- `${CLAUDE_PLUGIN_ROOT}/skills/00-async-dev/assets/setup/config-template.json` - `.claude/aidd-orchestrator.json` skeleton.
