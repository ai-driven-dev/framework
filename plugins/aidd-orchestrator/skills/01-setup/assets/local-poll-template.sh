...
process_label "$TO_IMPLEMENT" "Use skill aidd-orchestrator:02:run on issue #NUM in $REPO"
process_label "$TO_REVIEW" "Use skill aidd-orchestrator:03:review for issue #NUM in $REPO"
