...
| Tier   | Label        | Modèles exemples         | Usage                                                                    | Coût relatif |
| ------ | ------------ | ------------------------ | ------------------------------------------------------------------------ | ------------ |
| **T1** | **Fast**     | Claude Haiku, Grok Fast  | Tâches mécaniques, déterministes, templates, git ops                     | 1x           |
| **T2** | **Balanced** | Claude Sonnet, GPT Codex | Implémentation, analyse structurée, validation, génération de code       | 8x           |
| **T3** | **Thinking** | Claude Opus, GPT 5.2     | Raisonnement profond, synthèse, planification, orchestration, onboarding | 30x          |
