...
Then set up project context (guided **onboard**, or direct **project-memory**) and run the dev flow:
...
flowchart TD
    ...
    Init["aidd-context:02-project-memory - context engineering"]
...
Note: `aidd_docs/` and similar directories generated by `aidd-context:02-project-memory` belong to user projects, not to this marketplace. Do not link them from framework-level documentation.
