...
- **Authored for Claude Code.** Other tools install from a flat archive (download → unzip; see [Other tools](../README.md#other-tools)); a CLI-registered marketplace flow is on the way, and native parity is a roadmap item, not a guarantee today.
