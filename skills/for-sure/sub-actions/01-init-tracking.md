...
8. Read `references/tracking-template.md`. Create `{{DOCS}}/tasks/` if needed.

9. Create `{{DOCS}}/tasks/<task-name>.in-progress.md` with all fields filled. Include journey map.

### Spawn

10. Read the **Prompt** section of `sub-actions/02-autonomous-loop.md`. Pass it to the Agent tool with `<task-name>` filled in.
...
Read `references/tracking-template.md` for file format.
