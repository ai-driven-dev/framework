...
| `ToolId`           | `src/domain/models/tool-config.ts`     |
| `AiToolId`         | `src/domain/models/tool-config.ts`     |
| `IdeToolId`        | `src/domain/models/tool-config.ts`     |
| `ToolConfig`       | `src/domain/models/tool-config.ts`     |
| `AiToolConfig`     | `src/domain/models/tool-config.ts`     |
| `IdeToolConfig`    | `src/domain/models/tool-config.ts`     |
| `isAiToolConfig`   | `src/domain/models/tool-config.ts`     |
