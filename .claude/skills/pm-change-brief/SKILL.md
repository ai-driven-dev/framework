...
description: 'Generates a change brief documenting the as-is to to-be gap for a brownfield evolution. Use when you need to clarify what changes and what stays the same on an existing system.'
---
...
6. Read the template from Resources. Follow its exact structure — same headings, same table columns, same formats. Do not add, remove, or rename sections.
7. Calculate RICE score for prioritization
...
11. Verify format requirements: (none — structure only for this skill)
...
12. Save as `aidd_docs/tasks/YYYY-MM-DD-{change-name}/change-brief.md`
...
| Input    | `aidd_docs/memory/internal/prd.md`             | Product spec (if available)              |
| Input    | `aidd_docs/memory/internal/constitution.md`    | Project constraints & values (if available) |
| Template | `aidd_docs/templates/pm/change_brief.md`       | Change brief template                    |
