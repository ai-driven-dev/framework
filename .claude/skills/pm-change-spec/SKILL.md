---
name: 'pm-change-spec'
description: 'Generates detailed change specification and brownfield user stories from a change brief. Use when you need to specify what changes and what stays, with INVEST-compliant stories.'
---
...
7. Write user stories in brownfield format:
...
10. Verify format: Gherkin syntax correct, INVEST checklist referenced, preservation references system_overview
...
11. Save as `aidd_docs/tasks/YYYY-MM-DD-{change-name}/change-spec.md`
...
| Input | `aidd_docs/memory/internal/prd.md`             | Greenfield user stories (if available)   |
