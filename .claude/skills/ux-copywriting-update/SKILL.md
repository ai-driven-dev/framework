...
description: 'Generates i18n-ready microcopy for new and modified screens in a brownfield change. Use when you need UX copy scoped to a change, not the full product.'
---
...
8. If the change introduces onboarding for a new feature:
...
10. Verify format: i18n keys follow naming convention, tone matches existing product copy
...
11. Save as `aidd_docs/tasks/YYYY-MM-DD-{change-name}/ux-copy-update.md`
...
| Input    | `aidd_docs/memory/internal/ux_copy.md`         | Existing UX copy (if available, for tone) |
| Template | `aidd_docs/templates/ux/ux_copy.md`            | UX copy template (section structure)      |
