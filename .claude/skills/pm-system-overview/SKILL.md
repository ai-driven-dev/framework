...
description: 'Analyzes an existing codebase and generates a pragmatic system overview. Use when starting a brownfield project to understand the current system state.'
---
...
5. Detect pain points from code patterns (duplication, complexity, outdated dependencies)
...
7. Read the template from Resources
8. Verify every template section exists in the output with the exact same heading name and no section was added beyond what the template defines
...
10. Read the template from Resources. Follow its exact structure — same headings, same table columns, same formats. Do not add, remove, or rename sections.
11. Generate a system overview with Mermaid diagrams
12. Save as `aidd_docs/memory/internal/system_overview.md`
...
| -------- | ------------------------------------------------- | ------------------ |
| Output   | `aidd_docs/memory/internal/system_overview.md`     | Generated overview |
| Template | `aidd_docs/templates/pm/system_overview.md`        | Overview template  |
