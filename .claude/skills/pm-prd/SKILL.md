---
name: 'pm-prd'
description: 'Generates a comprehensive PRD from a validated product brief. Use when you need to transform a product brief into a full Product Requirements Document.'
---
...
5. Highlight the "invisibles" (Non-Goals, Edge Cases, Error States, Risks, Security, Assumptions)
...
6. Read the template from Resources
7. Verify every template section exists in the output with the exact same heading name and no section was added beyond what the template defines
8. Verify format requirements:
...
9. Save as `aidd_docs/memory/internal/prd.md`
...
| -------- | --------------------------------------------- | -------------------- |
| Input    | `aidd_docs/memory/internal/product_brief.md`   | Validated brief      |
| Input    | `aidd_docs/memory/internal/constitution.md`    | Project constitution |
| Template | `aidd_docs/templates/pm/prd.md`                | PRD template         |
