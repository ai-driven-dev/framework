...
├── .opencode/               # ⚙️ OpenCode (commands, agents, rules, skills)
├── aidd_docs/
...
1. Install [the AI-Driven Development framework](aidd_docs/templates/docs/INSTALL.md).
...
- [`INSTALL.md`](aidd_docs/templates/docs/INSTALL.md) — Installation guide.
