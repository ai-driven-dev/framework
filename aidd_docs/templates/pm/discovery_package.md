...
> For market research and personas from secondary data, use RESEARCH_REPORT.md.
...
> Section filled after prototyping. Captures user feedback on the prototype to feed the PRD.
