# Release v3.7.3-pm.1 — PM & UX Beta (2nd iteration)
...
aidd auth login
aidd setup --release v3.7.3-pm.1
```

**Existing project — one tool**
```bash
aidd install claude --release v3.7.3-pm.1
# Replace claude with cursor, copilot, or opencode
```

**Existing project — all tools**
```bash
aidd install --all --release v3.7.3-pm.1
```

**Update an already-installed project**
```bash
aidd update --release v3.7.3-pm.1
# Target a specific tool:
aidd update --release v3.7.3-pm.1 --tool claude
```
...
## Full feature set (v3.7.0-pm.1 + v3.7.3-pm.1)
