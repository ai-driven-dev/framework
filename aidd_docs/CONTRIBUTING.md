...
All templates live in `aidd_docs/templates/` and can be modified to match your team's conventions. Changes are tracked via hashes in `.aidd/manifest.json` — the CLI will warn before overwriting modified files on update.
