...
- Extract components from image: `@.cursor/commands/03_plan/image_extract_details.md`

#### Instruction steps

```text
@.cursor/commands/04_code/implement_from_design.md
```
...
```text
@.cursor/commands/04_code/assert_frontend.md
```
...
```text
@.cursor/commands/06_tests/test_journey.md
```
