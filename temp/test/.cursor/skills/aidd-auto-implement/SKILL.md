...
1. Brainstorm implementation approach: .cursor/commands/02_context/brainstorm.md
2. Generate technical plan: .cursor/commands/03_plan/plan.md
3. Implement changes: .cursor/commands/04_code/implement.md
4. Run tests: Execute test suite if applicable
5. Commit changes: .cursor/commands/08_deploy/commit.md
6. Code review: .cursor/commands/05_review/review_code.md
7. Functional review: .cursor/commands/05_review/review_functional.md
8. Create PR: .cursor/commands/08_deploy/create_request.md
