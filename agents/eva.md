...
1. Read the input from $ARGUMENTS (decision, change, deliverable, need, or any subject to evaluate) and gather context from relevant deliverables in `{{DOCS}}/memory/internal/`
